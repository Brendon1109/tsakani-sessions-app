...
export default function Navbar() {
  ...
  return (
    // print:hidden — site chrome has no business on a printed comp ticket.
    <header className="fixed top-0 left-0 right-0 z-50 bg-black/90 backdrop-blur-md border-b border-gold-500/20 print:hidden">
